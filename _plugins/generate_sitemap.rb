...
#
#
# Modifications by Joe Fiorini (c) 5/2/2011, http://userobsessed.net
#
# - Ignore index pages generated for pagination
# - Remove '.html' from end of .markdown pages for URLs that are /page/
#
#
  ...
  class SitemapGenerator < Generator
    ...
    def generate_content(site)
      ...
      site.pages.each{ |page|
        ...
        # Ignore pages generated for pagination
        next if page.subfolder =~ /page\d?/
    ...
    def entry(path, date)
        # Force extensions to nothing from markdown, textile.
        path = path.gsub(/\.(markdown|textile)$/i, '/')
      "
  <url>
